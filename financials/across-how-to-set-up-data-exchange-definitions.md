...
#### <a name="to-map-columns-in-the-data-file-to-fields-in-include-d365finincludesd365finmdmd"></a>To map columns in the data file to fields in [!INCLUDE [d365fin](includes/d365fin_md.md)]  
